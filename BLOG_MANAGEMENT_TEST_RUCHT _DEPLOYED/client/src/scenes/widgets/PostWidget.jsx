...
const PostWidget = ({
  ...
  const patchLike = async () => {
    // console.log("HEYO");
    const response = await fetch(`http://192.168.1.5:3001/posts/${postId}/like`, {
      method: "PATCH",
      headers: {
  ...
  const patchComment = async () => {
    ...
    // ToggleComments(!showComments);
    const response = await fetch(`http://192.168.1.5:3001/posts/${postId}/comment`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
    ...
    <WidgetWrapper m="2rem 0">
      ...
      {picturePath && (
        <img
          ...
          src={`http://192.168.1.5:3001/assets/${picturePath}`}
        />
      )}
